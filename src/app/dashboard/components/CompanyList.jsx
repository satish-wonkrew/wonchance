...
import CreateCompany from "./forms/company/CompanyCreate";
      ...
      {selectedCompany && !showUpdateForm && (
        <Modal onClose={() => setSelectedCompany(null)}>
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg relative">
            ...
            <p>
              <strong>Type:</strong> {selectedCompany.companyName}
            </p>
            <p>
            ...
            <p>
              <strong>Owner:</strong> {selectedCompany.ownerFirstName}{" "}
              {selectedCompany.ownerLastName}
            </p>
            <img
